...
from .ga_operators import calculate_fitness, calculate_mo_fitness, \
...
from ..MOO.nsga2_algorithm import *
# Import các module GP
from ..GP.gp_structures import Individual
from ..GP.gp_operators import create_population, gp_crossover, gp_mutation
